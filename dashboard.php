...
<div class="dashboard-container">
    ...
    <!-- Ficha de lista de amigos -->
    <div class="card">
        <h3>Lista de amigos agregados</h3>
        <p>Revisa la lista de tus amigos</p>
        <a href="logout.php">ver lista de amigos</a>
    </div>

    
    <!-- Ficha de historial de batalla -->
    <div class="card">
        <h3>Historial de batallas</h3>
        <p>Revisa tus ultimas batallas</p>
        <a href="logout.php">ver historial</a>
    </div>
